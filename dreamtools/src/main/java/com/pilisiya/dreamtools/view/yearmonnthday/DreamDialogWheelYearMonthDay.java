...
public class DreamDialogWheelYearMonthDay extends DreamDialog {
    ...
    public DreamDialogWheelYearMonthDay(Context mContext) {
        super(mContext);
    ...
    public DreamDialogWheelYearMonthDay(Context mContext, int beginYear) {
        super(mContext);
        // TODO Auto-generated constructor stub
        this.mContext = mContext;
    ...
    public DreamDialogWheelYearMonthDay(Context mContext, int beginYear, int endYear) {
        super(mContext);
        // TODO Auto-generated constructor stub
        this.mContext = mContext;
        this.beginYear = beginYear;
    ...
    public DreamDialogWheelYearMonthDay(Context mContext, TextView tvTime) {
        super(mContext);
        // TODO Auto-generated constructor stub
        this.mContext = mContext;
        build();
    ...
    private void build() {
        ...
        final View dialogView1 = LayoutInflater.from(mContext).inflate(R.layout.dream_dialog_year_month_day, null);

        OnWheelChangedListener listener = (wheel, oldValue, newValue) -> updateDays(mYearView, mMonthView, mDayView);
