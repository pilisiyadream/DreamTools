...
public class DreamDialog extends Dialog {
    ...
    public DreamDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public DreamDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView(Context context) {
        ...
        this.getWindow().setBackgroundDrawableResource(R.drawable.dream_transparent_bg);
        mContext = context;
     ...
     */
    public DreamDialog(Context context, float alpha, int gravity) {
        super(context);
