...
public class PickerView extends View {
	...
	private void init() {
		...
		linePaint.setColor(getResources().getColor(R.color.dream_line_color));
	...
	private void drawData(Canvas canvas) {
		...
		canvas.drawLine(0, 3 * mMaxTextSize - mMinTextSize / 2, mViewWidth, 3 * mMaxTextSize - mMinTextSize / 2,
				linePaint);
		canvas.drawLine(0, mMaxTextSize + mMinTextSize / 2, mViewWidth, mMaxTextSize + mMinTextSize / 2, linePaint);
