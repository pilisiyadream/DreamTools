package com.pilisiya.dreamtools.view.loading;
...
//        canvas.restore();
    ...
    private void drawLoading(Canvas canvas) {
        ...
        if (mCurrentShape == Shape.SHAPE_TRIANGLE)
            canvas.rotate(rotateTriangle, mWidth / 2, mHeight / 2 - rectLength/2 + (80 / 3));
        else
    ...
    private void drawCircle(Canvas canvas) {
        mPaint.setColor(Color.parseColor("#aa00aaee"));
    ...
    private void drawRect(Canvas canvas) {
        mPaint.setColor(Color.parseColor("#aa7602f8"));
    ...
    private void drawTriangle(Canvas canvas) {
        mPaint.setColor(Color.parseColor("#aaf63a4c"));
        Path path = new Path();
