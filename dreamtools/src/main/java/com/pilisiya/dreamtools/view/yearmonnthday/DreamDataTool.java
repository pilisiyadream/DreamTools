...
import static com.pilisiya.dreamtools.view.yearmonnthday.DreamConstTool.BYTE;
import static com.pilisiya.dreamtools.view.yearmonnthday.DreamConstTool.GB;
import static com.pilisiya.dreamtools.view.yearmonnthday.DreamConstTool.KB;
import static com.pilisiya.dreamtools.view.yearmonnthday.DreamConstTool.MB;
...
public class DreamDataTool {
    ...
    public static int[] stringToInts(String s) {
        ...
        if (DreamDataTool.isNullString(s)) {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link DreamConstTool.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link DreamConstTool.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link DreamConstTool.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link DreamConstTool.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, DreamConstTool.MemoryUnit unit) {
        if (byteNum < 0) {
            return -1;
        }
        switch (unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, DreamConstTool.MemoryUnit unit) {
        if (size < 0) {
            return -1;
        }
        switch (unit) {
